...
MONTHS = [
    ...
    ("8月", "インターハイ本戦 決勝／和倉ユース（8/6〜10）／選手権 1次予選 開始", "和倉ユース・夏期強化合宿・招待大会", "（サマーブレイク 継続）"),
...
COMPETITIONS = [
    ...
    ("Jユースカップ（Jリーグユース選手権）", "10/2〜翌6/13", "/tournaments/j-youth-cup-2026-27/",
     "Jクラブのユース（U-18）等<strong>64チーム</strong>（J1・J2・J3の58チーム＋予備予選から6クラブ）が争う大会。<strong>2026/27（第33回）から年度をまたぐ日程に変わり</strong>、10/2開幕・2027年6月13日決勝。1回戦ノックアウト→<strong>2回戦はA〜Hの8グループによるリーグ戦</strong>→ノックアウトラウンドの3ラウンド制。"),
    ("和倉ユースサッカー大会", "夏・8/6〜10", "/tournaments/wakura-youth-2026/",
     "石川県ユースサッカーフェスティバルの最上位カテゴリーにあたる<strong>夏の招待大会</strong>。高体連39校とJクラブユース9チームの<strong>計48チーム</strong>が4チーム×12グループの予選リーグを戦い、決勝トーナメントと順位決定戦で<strong>1位から48位まですべての順位</strong>を決めます。インターハイ決勝の中4日で開幕するため出場15校が連戦となるのが特徴。60分（30分ハーフ）・延長なし即PK・交代6名。2026年（第14回）は<strong>前橋育英が3度目の優勝</strong>。"),
    ("日本クラブユースサッカー選手権（U-18）", "冬・12/23〜29", "/tournaments/club-youth-2026/",
    ...
    ("新人戦（都道府県大会→9地域大会）", "1〜3月", "/tournaments/shinjinsen-2026-27/",
     "3年生引退後、1・2年生の<strong>新チーム最初の公式戦</strong>。地区予選→都道府県大会（概ね1〜2月）→各地域大会（九州＝<strong>KYFA U-17大会</strong>、関東＝記念大会 など。概ね2〜3月）。<strong>全国大会はなく地域大会が最高峰</strong>で、翌シーズンの勢力図を占う前哨戦になります。"),
    ("12月のプレーオフ・ファイナル", "12月（予定）", "/tournaments/premier-final-2026/",
