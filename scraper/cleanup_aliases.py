...
MANUAL_RENAMES: dict[tuple[str, str], str] = {
    ...
    # === 表記揺れ重複の整理 (手動マッピング) ===
    # 茨城県: 明秀日立A → 明秀学園日立高校 に統一
    ("ibaraki", "明秀日立A"): "明秀学園日立高校",
    # 岐阜県: 帝京可児B → 帝京大学可児高校2nd に統一
    ("gifu", "帝京可児B"): "帝京大学可児高校2nd",
    # 愛知県: グランパスB → 名古屋グランパスU-18 2nd に統一  
    ("aichi", "グランパスB"): "名古屋グランパスU-18 2nd",
    # 愛知県: 日福大付 → 日本福祉大学付属高校 に統一
    ("aichi", "日福大付"): "日本福祉大学付属高校",
    # 大阪府: 近大附属 → 近畿大学附属高校 に統一
    ("osaka", "近大附属"): "近畿大学附属高校",
    # 兵庫県: 神戸科技A → 神戸科学技術高校 に統一
    ("hyogo", "神戸科技A"): "神戸科学技術高校",
    # 兵庫県: 神戸国際附A → 神戸国際附属高校 に統一
    ("hyogo", "神戸国際附A"): "神戸国際附属高校",
    # 兵庫県: 神戸弘陵B → 神戸弘陵学園高校2nd に統一
    ("hyogo", "神戸弘陵B"): "神戸弘陵学園高校2nd",
    # 徳島県: 徳島ヴォルティスS → 徳島ヴォルティスユース2nd に統一
    ("tokushima", "徳島ヴォルティスS"): "徳島ヴォルティスユース2nd",
    # 徳島県: 徳島市立S → 徳島市立高校2nd に統一
    ("tokushima", "徳島市立S"): "徳島市立高校2nd",
    # 徳島県: 徳島商業S → 徳島商業高校2nd に統一
    ("tokushima", "徳島商業S"): "徳島商業高校2nd",
    # 愛媛県: 今治東S → 県立今治東中等教育学校 2nd に統一
    ("ehime", "今治東S"): "県立今治東中等教育学校 2nd",
    # 愛媛県: 愛媛FCU-18S → 愛媛FC U-18 2nd に統一
    ("ehime", "愛媛FCU-18S"): "愛媛FC U-18 2nd",
    # 愛媛県: FC今治U-18S → FC今治U-18 2nd に統一
    ("ehime", "FC今治U-18S"): "FC今治U-18 2nd",
    # 福岡県: 福大若葉 → 福岡大学附属若葉高校 に統一
    ("fukuoka", "福大若葉"): "福岡大学附属若葉高校",
    # 福岡県: 福大大濠 → 福岡大学附属大濠高校 に統一
    ("fukuoka", "福大大濠"): "福岡大学附属大濠高校",
    # 福岡県: 東海大福岡B → 東海大学付属福岡高校2nd に統一
    ("fukuoka", "東海大福岡B"): "東海大学付属福岡高校2nd",
    # 熊本県: 学園大付 → 熊本学園大学付属高校 に統一
    ("kumamoto", "学園大付"): "熊本学園大学付属高校",
    # 熊本県: ロアッソ2nd → ロアッソ熊本U-18_2nd に統一
    ("kumamoto", "ロアッソ2nd"): "ロアッソ熊本U-18_2nd",
    # 大分県: トリニータ2nd → 大分トリニータU-18_2nd に統一
    ("oita", "トリニータ2nd"): "大分トリニータU-18_2nd",
    # 宮崎県: 宮崎日大 → 宮崎日本大学高校 に統一
    ("miyazaki", "宮崎日大"): "宮崎日本大学高校",
    # === Phase: v9 dedup スキップ救済（略称→正式名）===
    ("ibaraki", "明秀日立A"): "明秀学園日立高校",
    ("tochigi", "文星芸大附"): "文星芸術大学附属高校",
    ("gunma", "健大高崎"): "高崎健康福祉大学高崎高校",
    ("gunma", "高経大附属"): "高崎経済大学附属高校",
    ("kanagawa", "日大藤沢B"): "日本大学藤沢高校2nd",
    ("gifu", "帝京可児B"): "帝京大学可児高校2nd",
    ("aichi", "日福大付"): "日本福祉大学付属高校",
    ("shimane", "立正大淞南B"): "立正大学淞南高校2nd",
    ("okayama", "ファジ岡山U-18B"): "ファジアーノ岡山U-18 2nd",
    ("okayama", "作陽B"): "作陽学園高校2nd",
    ("ehime", "愛媛FCU-18S"): "愛媛FC U-18 2nd",
    ("ehime", "FC今治U-18S"): "FC今治U-18 2nd",
    ("fukuoka", "福大若葉"): "福岡大学附属若葉高校",
    ("fukuoka", "東海大福岡B"): "東海大学付属福岡高校2nd",
