  ...
  <main class="main-content">
    <div class="container">
      ...
      <section class="lp-section">
        ...
        <p class="u15-note">
          ※<strong>多くの地域リーグは夏季中断中で、9月に再開します。</strong>掲載しているのは中断時点（前半戦終了時点）の順位です。
          消化試合数がチームによって異なる場合があります。<br>
          ※各順位表は掲載前に「勝点＝勝×3＋分」「試合数＝勝＋分＋敗」「リーグ内の得点合計＝失点合計」を機械的に検算しています。<br>
