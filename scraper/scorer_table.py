...
def render_scorer_ranking_html(slug: str, limit: int = 20) -> str:
    ...
    return f"""
      <section class="xs-section" id="scorer-ranking">
        ...
        .xs-table{{width:100%;border-collapse:collapse;font-size:15px;background:#fff;}}
        .xs-table th,.xs-table td{{border-bottom:1px solid #eee;padding:9px 12px;text-align:left;}}
        ...
        .xs-table .xs-tm{{color:inherit;opacity:.8;font-size:14px;}}
